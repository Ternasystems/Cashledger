 ...
 * This ensures that the repository layer is decoupled from any specific
...
interface IContext
{
    ...
    /**
     * Executes a command that modifies data (e.g., INSERT, UPDATE, DELETE, CALL).
     * @param string $sql The raw SQL command.
