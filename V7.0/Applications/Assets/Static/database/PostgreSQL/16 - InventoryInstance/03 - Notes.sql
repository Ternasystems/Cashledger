...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, NOW(), NULL, %L) ON CONFLICT ("DeliveryNumber") DO NOTHING;', _tablename, _id, _deliverynumber, _reference, _deliverydate, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, NOW(), NULL, %L) ON CONFLICT ("DispatchNumber") DO NOTHING;', _tablename, _id, _dispatchnumber, _reference, _dispatchdate, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, NOW(), NULL, %L) ON CONFLICT ("ReturnNumber") DO NOTHING;', _tablename, _id, _returnnumber, _reference, _returndate, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, NOW(), NULL, %L) ON CONFLICT ("WasteNumber") DO NOTHING;', _tablename, _id, _inventnumber, _reference, _inventdate, _description);
	-- Execute sql
