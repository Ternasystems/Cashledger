...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NULL, %L) ON CONFLICT ("TitleID", "ProfileID") DO NOTHING;', _tablename, _id, _titleid, _profileid, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NULL, %L) ON CONFLICT ("StatusID", "ProfileID") DO NOTHING;', _tablename, _id, _statusid, _profileid, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NULL, %L) ON CONFLICT ("GenderID", "ProfileID") DO NOTHING;', _tablename, _id, _genderid, _profileid, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NULL, %L) ON CONFLICT ("CivilityID", "ProfileID") DO NOTHING;', _tablename, _id, _civilityid, _profileid, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NULL, %L) ON CONFLICT ("OccupationID", "ProfileID") DO NOTHING;', _tablename, _id, _occupationid, _profileid, _description);
	-- Execute sql
