...
BEGIN
	...
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, %L, NULL, %L) ON CONFLICT ("ProfileID", "ContactNo") DO NOTHING;', _tablename, _id, _contacttypeid, _profileid, _no, _name, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, %L, NULL, %L) ON CONFLICT ("LangID", "ContactID", "Contact") DO NOTHING;', _tablename, _id, _langid, _contactid, _contact, _photo, _description);
	-- Execute sql
