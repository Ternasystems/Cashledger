	...
	BEGIN
		...
		EXECUTE FORMAT('
			...
			BEGIN
				...
				-- Insert data into cl_Roles
				INSERT INTO public.%I VALUES (_id, _roleid, _controller, _action, _permissions, NULL, _description) ON CONFLICT ("RoleID", "Controller", "Action") DO NOTHING;
				--
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NULL, %L) ON CONFLICT ("CredentialID", "RoleID") DO NOTHING;', _tablename, _id, _credentialid, _roleid, _description);
	-- Execute sql
