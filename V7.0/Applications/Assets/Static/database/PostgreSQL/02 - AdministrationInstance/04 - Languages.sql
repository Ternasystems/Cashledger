...
(
	...
	"Label" character varying(50) COLLATE pg_catalog."default" UNIQUE NOT NULL,
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, NULL, %L) ON CONFLICT ("TableName") DO NOTHING;', _tablename, _id, _name, _description);
	-- Execute sql
...
(
	...
	"IsActive" timestamp without time zone,
	"Description" text COLLATE pg_catalog."default",
	CONSTRAINT "UQ_ReferenceRelation" UNIQUE ("ReferenceID", "AppID")
)
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NULL, %L) ON CONFLICT ("ReferenceID", "AppID") DO NOTHING;', _tablename, _id, _referenceid, _appid, _description);
	-- Execute sql
...
(
	...
	"ReferenceID" character varying(50) COLLATE pg_catalog."default" NOT NULL CHECK (public."f_CheckReference"("ReferenceID")), -- All translatable tables
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, NULL, %L) ON CONFLICT ("ReferenceID", "LangID") DO NOTHING;', _tablename, _id, _langid, _referenceid, _label, _description);
	-- Execute sql
...
CALL public."p_InsertLanguage"('GQ', 'Español');
CALL public."p_InsertLanguage"('TD', 'عربي');