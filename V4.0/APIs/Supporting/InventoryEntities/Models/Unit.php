...
{
    public function __construct(\API_InventoryRepositories_Model\Unit $_entity, ?LanguageRelations $_languageRelations)
    {
    ...
    public function It(): \API_InventoryRepositories_Model\Unit
    {
        ...
        if (!$entity instanceof \API_InventoryRepositories_Model\Unit)
            throw new UnexpectedValueException('Object must be an instance of '.\API_InventoryRepositories_Model\Unit::class);
