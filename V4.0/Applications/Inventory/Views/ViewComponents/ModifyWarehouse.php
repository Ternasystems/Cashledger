...
?>
<div id="main">
    <form id="modify-warehouse" name="modify-warehouse" method="post" action="UpdateWarehouse">
        <!--Title-->
        <div class="title">
            <span><?= $components['NavModifyWarehouse'][$lang]['title']; ?></span>
        </div>
        <div id="form-body">
            <!-- Warehouse name -->
            <div class="form-elt">
                ...
                <input id="warehouseid" type="hidden" name="warehouseid" value="">
            </div>
            <!-- Warehouse location -->
            <div class="form-elt">
    ...
    <div id="warehouse-list">
        ...
        if (isset($warehouses)) {
            foreach ($warehouses as $warehouse) {
                ?>
                <div class="warehouse-elt ts-elt" data-form="#modify-warehouse" data-id="<?= $warehouse->It()->Id; ?>"><?= $warehouse->It()->Name; ?></div>
                <?php
            }
        }
        ?>
