...
$xmlLocale = new XMLManager(dirname(__DIR__, 2).'\Assets\Locales\NewManufacturerLocale.xml');
...
?>
<div id="main">
    <form id="new-manufacturer" name="new-manufacturer" method="post" action="AddManufacturer">
        <!--Title-->
        <div class="title">
            <span><?= $components['NavNewManufacturer'][$lang]['title']; ?></span>
        </div>
        <div id="form-body">
            <!-- Manufacturer name -->
            <div class="form-elt">
    ...
    <div id="manufacturer-list">
        ...
        if (isset($manufacturers)) {
            foreach ($manufacturers as $manufacturer) {
                ?>
                <div class="manufacturer-elt"><?= $manufacturer->It()->Name; ?></div>
                <?php
            }
        }
        ?>
