...
?>
<div id="main">
    <form id="modify-unit" name="modify-unit" method="post" action="UpdateUnit">
        <!--Title-->
        <div class="title">
            <span><?= $components['NavModifyUnit'][$lang]['title']; ?></span>
        </div>
        <div id="form-body">
            <!-- Unit name -->
            <div class="form-elt">
    ...
    <div id="unit-list">
        ...
        if (isset($units)) {
            ...
            foreach ($relations as $key => $relation) {
                ?>
                <div class="unit-elt ts-elt" data-form="#modify-unit" data-id="<?= $key; ?>"><?= $relation ?></div>
                <?php
            }
        }
        ?>
