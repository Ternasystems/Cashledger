...
$NavLocales = [
    ...
    'NavCustomer' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Inventory', 'Home', 'NavCustomer'),
    'NavSupplier' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Inventory', 'Home', 'NavSupplier')
];

$NavItems = ['NavGeneral', 'NavWareHouse', 'NavProduct', 'NavCustomer', 'NavSupplier'];
