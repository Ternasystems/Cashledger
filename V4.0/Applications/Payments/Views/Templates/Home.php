...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Payments/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Payments/Payments.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Payments', 'Home', 'Title') ];
