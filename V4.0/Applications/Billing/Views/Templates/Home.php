...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Billing/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Billing/Billing.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Billing', 'Home', 'Title') ];
