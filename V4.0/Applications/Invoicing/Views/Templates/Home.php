...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Invoicing/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Invoicing/Invoicing.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Invoicing', 'Home', 'Title') ];
