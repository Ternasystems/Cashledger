...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Accounting/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Accounting/Accounting.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Accounting', 'Home', 'Title') ];
