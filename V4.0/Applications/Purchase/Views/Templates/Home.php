...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Purchase/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Purchase/Purchase.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Purchase', 'Home', 'Title') ];
