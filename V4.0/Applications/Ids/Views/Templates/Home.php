...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Ids/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Ids/Ids.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Ids', 'Home', 'Title') ];
