...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Payroll/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Payroll/Payroll.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Payroll', 'Home', 'Title') ];
