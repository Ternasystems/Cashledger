...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Control/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Control/Control.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Control', 'Home', 'Title') ];
