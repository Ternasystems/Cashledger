...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Wholesale/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Wholesale/Wholesale.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Wholesale', 'Home', 'Title') ];
