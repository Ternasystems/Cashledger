...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Publishing/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Publishing/Publishing.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Publishing', 'Home', 'Title') ];
