...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Meeting/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Meeting/Meeting.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Meeting', 'Home', 'Title') ];
