...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Teller/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Teller/Teller.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Teller', 'Home', 'Title') ];
