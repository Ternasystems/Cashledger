...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Tasks/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Tasks/Tasks.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Tasks', 'Home', 'Title') ];
