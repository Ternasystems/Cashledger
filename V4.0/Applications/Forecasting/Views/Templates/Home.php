...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Forecasting/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Forecasting/Forecasting.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Forecasting', 'Home', 'Title') ];
