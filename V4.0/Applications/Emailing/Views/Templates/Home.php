...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Emailing/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Emailing/Emailing.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Emailing', 'Home', 'Title') ];
