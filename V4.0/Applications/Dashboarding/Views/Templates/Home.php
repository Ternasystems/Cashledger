...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Dashboarding/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Dashboarding/Dashboarding.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Dashboarding', 'Home', 'Title') ];
