...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Hudel/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Hudel/Hudel.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Hudel', 'Home', 'Title') ];
