...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Booking/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Booking/Booking.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Booking', 'Home', 'Title') ];
