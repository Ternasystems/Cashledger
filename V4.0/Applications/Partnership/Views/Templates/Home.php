...
// Set statics
$ViewData['css'] = $ViewData['cssPath'].'css.Partnership/Index.css';
$ViewData['js'] = $ViewData['jsPath'].'js.Partnership/Partnership.js';
...
$Localizer = [ 'Title' => $locales->getLocale($xmlLocale, $ViewData['CurrentLanguage'], 'Partnership', 'Home', 'Title') ];
