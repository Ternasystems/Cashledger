...
class ParameterRepository extends Repository
{
    ...
    public function first(?array $whereClause = null): ?Parameter
    {
        $entity = parent::first($whereClause);
        return $entity instanceof Parameter ? $entity : null;
    }

    public function getAll(?int $limit = null, ?int $offset = null, ?array $orderBy = null): ?Parameters
    {
        $collection = parent::getAll($limit, $offset, $orderBy);
        return $collection instanceof Parameters ? $collection : null;
    }
    ...
    public function getBy(?array $whereClause = null, ?int $limit = null, ?int $offset = null, ?array $orderBy = null): ?Parameters
    {
        $collection = parent::getBy($whereClause, $limit, $offset, $orderBy);
        return $collection instanceof Parameters ? $collection : null;
    }

    public function last(?array $whereClause = null): ?Parameter
    {
