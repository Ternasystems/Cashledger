...
/* Tellers, TellerSessions, PaymentMethods, TellerTransactions, TellerPayments */
...
(
	...
	"SessionState" character varying(50) COLLATE pg_catalog."default" NOT NULL,
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, %L, %L, %L, %L, %L, NOW());', _tablename, _id, _tellerid, _sessionid, action, _balance, _cashin, _cashout, _IP);
	-- Execute sql
...
(
	...
	"ReferenceID" character varying(50) COLLATE pg_catalog."default" NOT NULL CHECK (public."f_CheckReference"("ReferenceID", "AppID")),
...
CREATE OR REPLACE PROCEDURE public."p_InsertTellerTransaction"(
	...
	IN transactionstatus character varying(50),
	IN _approbator character varying(50),
	IN _description text DEFAULT NULL::text)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE _sql text; _tablename character varying(50) := 'cl_TellerTransactions'; _id character varying(50) := '%s';
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NOW(), %L, %L, %L, %L, %L, %L, %L, %L, %L);', _tablename, _id, _sessionid, _transactiondate, _referenceid, _appid, _transactiontype, _amount,
	_unitid, _transactionstatus, _tellerid, _approbator, _description);
	-- Execute sql
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, NOW(), %L, %L, %L, %L, %L, %L, %L, %L);', _tablename, _id, _paymentdate, _transactionid, _paymentid, _referencenumber, _amount, _tellerid, 
...
(
	...
	"EditDate" timestamp without time zone NOT NULL,
	"TransactionID" character varying(50) COLLATE pg_catalog."default" NOT NULL REFERENCES public."cl_TellerTransactions" ("ID") MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
	"ReceiptNumber" character varying(50) COLLATE pg_catalog."default" NOT NULL,
	"ReferenceID" character varying(50) COLLATE pg_catalog."default" NOT NULL CHECK (public."f_CheckReference"("ReferenceID", "AppID")),
	"AppID" character varying(50) COLLATE pg_catalog."default" NOT NULL REFERENCES public."cl_Apps" ("ID") MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
...
(
	...
	"Amount" numeric(8,2) NOT NULL CHECK ("Amount" >= 0),
	"TransferStatus" character varying(50) COLLATE pg_catalog."default" NOT NULL CHECK ("TrasnferStatus" IN ('PENDING', 'APPORVED', 'REJECTED')),
	"ApprovedBy" character varying(50) COLLATE pg_catalog."default" NOT NULL REFERENCES public."cl_Tellers" ("ID") MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
	"IsActive" timestamp without time zone,
	"Description" text COLLATE pg_catalog."default"
)
...
BEGIN
	-- Format sql
	_sql := FORMAT('INSERT INTO public.%I VALUES (%s, %L, %L, NOW(), %L, %L, %L, %L, %L, %L, %L, %L, %L);', _tablename, _id, _Transferdate, _transactionid, _receiptnumber, _referenceid, _appid, _tellerid,
	_description);
	-- Execute sql
	CALL public."p_Query"(_sql, _tablename, 'TRT');
END;
